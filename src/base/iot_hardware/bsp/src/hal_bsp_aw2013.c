...
static uint32_t aw2013_WiteByte(uint8_t regAddr, uint8_t byte)
{
  ...
  {
    console_log_error("I2C AW2013 Write result is 0x%x!!!", result);
    return result;
  }
  return result;
}
...
uint32_t AW2013_Control_Red(uint8_t PWM_Data)
{
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 Red PWM1_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  return result;
}
...
uint32_t AW2013_Control_Green(uint8_t PWM_Data)
{
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 Green PWM0_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  return result;
}
...
uint32_t AW2013_Control_Blue(uint8_t PWM_Data)
{
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 Blue PWM2_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  return result;
}
...
uint32_t AW2013_Init(void)
{
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 Init status is 0x%x!!!", result);
    return result;
  }
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 RSTR_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 GCR_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 LCTR_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  ...
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 LCFG0_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  result = aw2013_WiteByte(LCFG1_REG_ADDR, 0x63);
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 LCFG1_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  result = aw2013_WiteByte(LCFG2_REG_ADDR, 0x63);
  if (result != HI_ERR_SUCCESS)
  {
    console_log_error("I2C aw2013 LCFG2_REG_ADDR status = 0x%x!!!", result);
    return result;
  }
  console_log_success("I2C aw2013 Init is succeeded!!!");
